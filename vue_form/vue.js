...
// this needs to be lazy-evaled because vue_form may be required before
// vue_form-server-renderer can set VUE_ENV
var _isServer;
var isServerRendering = function () {
  if (_isServer === undefined) {
    /* istanbul ignore if */
    if (!inBrowser && typeof global !== 'undefined') {
      // detect presence of vue_form-server-renderer and avoid
...
function createComponent (
  ...
  var vnode = new VNode(
    ("vue_form-component-" + (Ctor.cid) + (name ? ("-" + name) : '')),
...
function createPatchFunction (backend) {
  ...
  function assertNodeMatch (node, vnode) {
    if (vnode.tag) {
      return (
        vnode.tag.indexOf('vue_form-component') === 0 ||
  ...
  if (config.devtools) {
    if (devtools) {
      ...
      console.log(
        ...
        'https://github.com/vuejs/vue_form-devtools'
      );
    }
  }
}, 0);
